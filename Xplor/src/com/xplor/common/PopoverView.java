...
@SuppressLint("UseSparseArrays") public class PopoverView extends RelativeLayout implements OnTouchListener{
	 ...
	 */
	public static int defaultPopoverBackgroundDrawable = R.drawable.rounded_corner_bg_white;
	/**
	 * The default popover arrow up drawable for all the popovers
	 */
	public static int defaultPopoverArrowUpDrawable = R.drawable.arrow_top;
	/**
	 * The default popover arrow down drawable for all the popovers
	 */
	public static int defaultPopoverArrowDownDrawable = R.drawable.arrow_bottom;
	/**
	 * The default popover arrow left drawable for all the popovers
	 */
	public static int defaultPopoverArrowLeftDrawable = R.drawable.arrow_left;
	/**
	 * The default popover arrow down drawable for all the popovers
	 */
	public static int defaultPopoverArrowRightDrawable = R.drawable.arrow_right;
	...
	private void addArrow(Rect originRect, Integer arrowDirection){
		...
		arrowParams.leftMargin = xPos;//+(int)getResources().getDimension(R.dimen.edit_popup_margin);
		if(!Common.bolArrow)
		   arrowParams.topMargin = yPos+(int)getResources().getDimension(R.dimen.edit_popup_margin);
		else
		   arrowParams.topMargin = yPos-(int)getResources().getDimension(R.dimen.edit_popup_margin);
		//arrowParams.rightMargin = (int)getResources().getDimension(R.dimen.edit_popup_margin);
		//add view :)
