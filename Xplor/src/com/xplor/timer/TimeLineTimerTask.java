...
public class TimeLineTimerTask extends AsyncTask<Void, Integer, Void> {
	
	private static final String TAG = TimeLineTimerTask.class.getSimpleName();
	final NewsFeedTimeLineParsing mInfo;
	String mGone = null;

	public TimeLineTimerTask(NewsFeedTimeLineParsing infoHome,String gone,long currentTimeMillis) {
		 mInfo = infoHome;
		 mGone = gone;
