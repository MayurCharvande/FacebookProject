...
public class StarTimelineListParsing {

	private String STR_FEED_ID, STR_SENDER_ID, STR_SENDER_NAME, STR_SENDER_TYPE, STR_STANDARD_MSG,STR_STANDARD_MSG_TYPE, 
	...
	private int STR_IMAGE_WIDTH,STR_IMAGE_HEIGHT;
	private int INT_WEIGHT, INT_HEIGHT, INT_ZC,INT_IS_LIKE, INT_APPROVE,
	...
	private StarTimerTask mStarTimerTask;
	...
	public StarTimelineListParsing(String filename, Integer size, Timer timer) {
		mFilename = filename;
		//mTextView = null;
		mStarTimerTask = null;
	}
	 ...
	 */
	public StarTimerTask getmFileDownloadTask() {
		return mStarTimerTask;
	}

	/**
	 * @param mFileDownloadTask the mFileDownloadTask to set
	 */
	public void setmFileDownloadTask(StarTimerTask starTimerTask) {
		this.mStarTimerTask = starTimerTask;
	}
