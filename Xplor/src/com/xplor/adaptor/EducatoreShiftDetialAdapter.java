...
public class EducatoreShiftDetialAdapter extends BaseAdapter {
	...
	public EducatoreShiftDetialAdapter(Activity _contex,ArrayList<EducatoreShift> _list) {
		_context = _contex;
		_listArray = _list;
	}
	...
	public View getView(final int position, View convertView, ViewGroup arg2) {
		...
		String startTime = Common.convertDateFormatShiftDetial(_listArray.get(position).shift_date);
		//String[] endTime = Common.convertDateAndTimeTolocalFormate(_listArray.get(position).shift_date + " " + endStart).split(" ");
		_viewHolder.mDay.setText(startTime);
		
		//_viewHolder.mTime.setText(startTime[2] + " " + startTime[3] + " - "+ endTime[2] + " " + endTime[3]);
		//_viewHolder.mTime.setText("Shift Time : "+startTime[2] + " " + startTime[3]);
		_viewHolder.mTime.setText("Shift Time : "+_listArray.get(position).shift_start_time);
