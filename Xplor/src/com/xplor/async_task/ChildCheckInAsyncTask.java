...
public class ChildCheckInAsyncTask extends AsyncTask<String, Integer, String> {
	...
	public ChildCheckInAsyncTask(Context context) {
		this.mContext = context;
		// create object web-service handler class.
		service = new ServiceHandler(context);
	}
	...
	protected String doInBackground(String... param) {
		...
		String strResponce = service.makeServiceCall(WebUrls.CHECK_IN_URL, Common.POST, params);
	...
	protected void onPostExecute(String strResponce) {
		...
		LogConfig.logd("Child checkin responce =",""+ strResponce);
	...
	private void parseResponce(String responce) {
		...
		mCheckStatusCallBack.requestCheckStatus(true,success, message);
	}
