...
public class GetBeaconsEducatorAsyncTask extends AsyncTask<String, Integer, String> {

	Activity mActivity = null;
	ServiceHandler service = null;
	private BeaconServiceCallBack callBack = null;

	public GetBeaconsEducatorAsyncTask(Activity activity) {
	...
	protected String doInBackground(String... param) {
		...
		String strResponce = service.makeServiceCall(WebUrls.EDUCATOR_BEACON_DETAILS_URL, Common.POST, params);
		LogConfig.logd("educator Becons list strResponce =",""+strResponce);
		return strResponce;
	}
